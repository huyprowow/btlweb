...
let inc = 0;
const CircleProgressCustom2 = (props) => {
    const { total } = props;
    ...
    return (
        <Box sx={{ position: 'relative', display: 'inline-flex' }}>
            ...
            >
                <Typography variant="static" component="div" color="#ffde3a">
...
// CircleProgressCustom2.propTypes = {
//   /**
...
// };
export default CircleProgressCustom2;
